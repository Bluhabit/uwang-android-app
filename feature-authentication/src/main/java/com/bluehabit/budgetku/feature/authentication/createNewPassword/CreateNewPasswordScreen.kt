...
@Navigation(
    route = Routes.CreateNewPassword.routeName,
    group = AuthenticationConstants.parentRoute,
    viewModel = CreateNewPasswordViewModel::class
)
@Composable
fun CreateNewPasswordScreen(
    uiContract: UIContract<CreateNewPasswordState, CreateNewPasswordIntent, CreateNewPasswordAction>,
    ...
    BaseScreen(
        ...
        Column(
            ...
            ButtonPrimary(
                ...
                onClick = { dispatch(CreateNewPasswordAction.Submit) }
            )
