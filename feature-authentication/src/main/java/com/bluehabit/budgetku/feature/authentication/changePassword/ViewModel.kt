...
class ChangePasswordViewModel @Inject constructor(
    ...
    private fun validateInputOldPassword(
        ...
        when {
            oldPassword.isEmpty() -> valid(false, controller.context.getString(R.string.subtitle_error_password_empty_change_password))
            else -> valid(true, "")
        }
    }
    ...
    private fun validateInputNewPassword(
        ...
        when {
            newPassword.isEmpty() -> valid(false, controller.context.getString(R.string.subtitle_error_password_empty_change_password))
            newPassword.length < 8 -> valid(false, controller.context.getString(R.string.subtitle_error_password_length_change_password))
            else -> valid(true, "")
        }
    }
    ...
    private fun validateConfirmNewPassword(
        ...
        when {
            confirmNewPassword != newPassword -> valid(false, controller.context.getString(R.string.subtitle_error_password_not_identical_change_password))
            confirmNewPassword.isEmpty() -> valid(false, controller.context.getString(R.string.subtitle_error_password_empty_change_password))
            else -> valid(true, "")
        }
    }
