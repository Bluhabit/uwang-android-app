    ...
    GaweanTheme() {
        Column(
            ...
            EmptySearchPage(
                ...
                icon = {
                    Image(
                        painter = painterResource(id = R.drawable.emptylistpage),
                        contentDescription = "",
                        modifier = Modifier.fillMaxWidth()
                    )
                },
                label = stringResource(id = R.string.text_title_empty_list_task),
                message = stringResource(id = R.string.text_placeholder_empty_list_task),
            )
        }
    }
}