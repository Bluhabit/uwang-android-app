...
class VerifyOtpSignInBasicUseCase @Inject constructor(
    private val authRepository: AuthRepository
) {
    suspend operator fun invoke(otp: String): Response<SignInBasicResponse> =
        authRepository.verifyOtpSignInBasic(otp)
}