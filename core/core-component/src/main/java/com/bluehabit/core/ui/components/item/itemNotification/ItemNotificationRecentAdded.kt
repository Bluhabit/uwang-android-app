...
@Composable
fun ItemNotificationRecentAdded(
    ...
    BaseItemNotification(
        modifier = modifier,
        icon = R.drawable.ic_notification_recent_added,
        read = read,
...
@Preview
@Composable
fun ItemNotificationRecentAddedPreview() {
    Column {
        ItemNotificationRecentAdded(
            title = "Tugas baru ditambahkan",
            message = "Anda telah menambahkan tugas baru",
