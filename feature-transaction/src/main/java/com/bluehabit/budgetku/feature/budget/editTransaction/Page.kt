...
fun ScreenEditTransaction(
    state: EditTransactionState = EditTransactionState(),
    data: EditTransactionDataState = EditTransactionDataState(),
    invoker: UIListenerData<EditTransactionState, EditTransactionDataState, EditTransactionEvent>
