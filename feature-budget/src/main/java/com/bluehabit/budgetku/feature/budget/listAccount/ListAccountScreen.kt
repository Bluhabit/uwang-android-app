...
@Navigation(
    route = Routes.ListAccount.routeName,
    viewModel = ListAccountViewModel::class
)
@Composable
fun ListAccountScreen(
    uiContract: UIContract<ListAccountState, ListAccountIntent, ListAccountAction>,
        ...
        if (showButton) {
            Column(
                ...
                ButtonPrimary(
                    text = "Tambah Akun",
                    onClick = {
                        navigator.navigateSingleTop(Routes.CreateAccountSaving.routeName)
                    }
                )
            }
        }
